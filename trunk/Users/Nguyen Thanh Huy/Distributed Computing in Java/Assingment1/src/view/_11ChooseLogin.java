...
public class _11ChooseLogin extends JFrame {
	public JButton btnVietnamese, btnEnglish, btnConnect, btnNotConnect, btnLogin;
	public JRadioButton radConnect, radNotConnect;
	
	public _11ChooseLogin() {
		initComponents();
	}
